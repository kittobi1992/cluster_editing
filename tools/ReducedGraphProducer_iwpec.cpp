...
std::cout << "number=" << number << std::endl;
				for (int k = 1; k < number+1; k++){
					try {
						...
						for (int l = 0; l < graph_set.getSetSize(); l++ ) {
							...
							cm_fname=cm_fname.append("Vred_").append(toString(Vred)).append("_krest_").append(toString(krest)).append("_c_").append(toString(j)).append("_Vorg_").append(toString(Vorg)).append("_korg_").append(toString(korg)).append("_lb_").append(toString((int)lb)).append("_ub_").append(toString((int)ub)).append("_nr_").append(toString(nr)).append(".cm");
							if (Vred < 3){ 
								help=false;
							}
							else{
		...
		for (int i=nr ; i < runs+nr; i++){	
				...
				for (int l = 0; l < graph_set.getSetSize(); l++ ) {
					...
					// create graph file name
					string cm_fname = "graph_";
					cm_fname=cm_fname.append("Vred_").append(toString(Vred)).append("_krest_").append(toString(krest)).append("_c_").append(toString(c*Graph_size)).append("_Vorg_").append(toString(Vorg)).append("_korg_").append(toString(korg)).append("_lb_").append(toString((int)lb)).append("_ub_").append(toString((int)ub)).append("_nr_").append(toString(nr)).append(".cm");
					if (Vred < 3){ 
						help=false;
					}
					else{
...
void setPath (int Vred, int krest, string &path_help, bool &help){
	...
	switch (Vred / 50){
		case 0: path_help=path_help.append("V_1-49_");
			break;
		case 1: path_help==path_help.append("V_50-99_");
			break;
		case 2: path_help=path_help.append("V_100-149_");
			break;
		case 3: path_help==path_help.append("V_150-199_");
			break;
		case 4: path_help=path_help.append("V_200-249_");
			break;
		case 5: path_help==path_help.append("V_250-299_");
			break;
		case 6: path_help=path_help.append("V_300-349_");	
			break;
		case 7: path_help==path_help.append("V_350-399_");
			break;
		case 8: path_help=path_help.append("V_400-449_");
			break;
		case 9: path_help==path_help.append("V_450-499_");
			break;
		case 10: path_help==path_help.append("V_500-549_");
			break;
		case 11: path_help==path_help.append("V_550-599_");
			break;
		case 12: path_help==path_help.append("V_600-649_");
			break;
		case 13: path_help==path_help.append("V_650-699_");
			break;
		case 14: path_help==path_help.append("V_700-749_");
			break;
		case 15: path_help==path_help.append("V_750-799_");
			break;                                               			
		case 16: path_help==path_help.append("V_800-849_");
			break;                                               			
		case 17: path_help==path_help.append("V_850-899_");
			break;                                               			
		case 18: path_help==path_help.append("V_900-949_");
			break;                                               			
		case 19: path_help==path_help.append("V_950-999_");
			break;                                               			
		//default: help=false;
        	default: path_help==path_help.append("V_1000_");
	}

	switch ((int) (4.0*krest / Vred)){	
		case 0:
        case 1:
		case 2: path_help=path_help.append("k_0.5V/");
			break;
		case 3:
        case 4: path_help==path_help.append("k_1V/");
			break;
		case 5:
		case 6: path_help=path_help.append("k_1.5V/");
			break;
		case 7:			
		case 8: path_help==path_help.append("k_2V/");
			break;
		case 9:			
		case 10: path_help=path_help.append("k_2.5V/");
			break;
		case 11:			
		case 12: path_help==path_help.append("k_3V/");
			break;
		case 13:			
		case 14: path_help=path_help.append("k_3.5V/");	
			break;
		case 15:			
		case 16: path_help==path_help.append("k_4V/");
			break;
		case 17:			
		case 18: path_help=path_help.append("k_4.5V/");
			break;
		case 19:			
		case 20: path_help==path_help.append("k_5V/");
			break;
		case 21:			
		case 22: path_help==path_help.append("k_5.5V/");
			break;
		case 23:
		case 24: path_help==path_help.append("k_6V/");
			break;
		case 25:			
		case 26: path_help==path_help.append("k_6.5V/");
			break;
		case 27:			
		case 28: path_help==path_help.append("k_7V/");
			break;
		case 29:
		case 30: path_help==path_help.append("k_7.5V/");
			break;
		case 31:			
		case 32: path_help==path_help.append("k_8V/");
			break;
		case 33:			
		case 34: path_help==path_help.append("k_8.5V/");
			break;
		case 35:			
		case 36: path_help==path_help.append("k_9V/");
			break;
		case 37:			
		case 38: path_help==path_help.append("k_9.5V/");
			break;
		case 39:			
		case 40: path_help==path_help.append("k_10V/");
			break;
		//default: help=false;
		default: path_help==path_help.append("k_10V/");
	}
}
