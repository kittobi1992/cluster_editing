                    ...
                    try {
                        ...
                        for (int l = 0; l < graph_set.getSetSize(); l++) {
                            ...
                            cm_fname = cm_fname.append("Vred_").append(toString(Vred)).append("_krest_").append(
                                    ...
                                    toString(Vorg)).append("_korg_").append(toString(korg)).append("_nr_").append(
...
void setPath(int Vred, int krest, string &path_help, bool &help) {
    switch (Vred / 25) {
        case 0:
            path_help = path_help.append("somethingelse");
            return;
            break;
        case 1:
        case 2:
            path_help = path_help.append("V_50_");
            break;
        case 3:
        case 4:
            path_help == path_help.append("V_100_");
            break;
        case 5:
        case 6:
            path_help = path_help.append("V_150_");
            break;
        case 7:
        case 8:
            path_help == path_help.append("V_200_");
            break;
        case 9:
        case 10:
            path_help = path_help.append("V_250_");
            break;
        case 11:
        case 12:
            path_help == path_help.append("V_300_");
            break;
        case 13:
        case 14:
            path_help = path_help.append("V_350_");
            break;
        case 15:
        case 16:
            path_help == path_help.append("V_400_");
            break;
        case 17:
        case 18:
            path_help = path_help.append("V_450_");
            break;
        case 19:
        case 20:
            path_help == path_help.append("V_500_");
            break;
        case 21:
        case 22:
            path_help == path_help.append("V_550_");
            break;
        case 23:
        case 24:
            path_help == path_help.append("V_600_");
            break;
        case 25:
        case 26:
            path_help == path_help.append("V_650_");
            break;
        case 27:
        case 28:
            path_help == path_help.append("V_700_");
            break;
        case 29:
        case 30:
            path_help == path_help.append("V_750_");
            break;
        case 31:
        case 32:
            path_help == path_help.append("V_800_");
            break;
        case 33:
        case 34:
            path_help == path_help.append("V_850_");
            break;
        case 35:
        case 236:
            path_help == path_help.append("V_900_");
            break;
        case 37:
        case 38:
            path_help == path_help.append("V_950_");
            break;
        case 39:
        case 40:
    ...
    switch ((int) (krest / (Vred / 2.0))) {
        ...
        case 1:
        case 2:
            path_help = path_help.append("k_01V/");
            break;
        case 3:
        case 4:
            path_help == path_help.append("k_02V/");
            break;
        case 5:
        case 6:
            path_help = path_help.append("k_03V/");
            break;
        case 7:
        case 8:
            path_help == path_help.append("k_04V/");
            break;
        case 9:
        case 10:
            path_help = path_help.append("k_05V/");
            break;
        case 11:
        case 12:
            path_help == path_help.append("k_06V/");
            break;
        case 13:
        case 14:
            path_help = path_help.append("k_07V/");
            break;
        case 15:
        case 16:
            path_help == path_help.append("k_08V/");
            break;
        case 17:
        case 18:
            path_help = path_help.append("k_09V/");
            break;
        case 19:
        case 20:
        ...
        case 21:
        case 22:
            path_help == path_help.append("k_11V/");
            break;
        case 23:
        case 24:
            path_help == path_help.append("k_12V/");
            break;
        case 25:
        case 26:
            path_help == path_help.append("k_13V/");
            break;
        case 27:
        case 28:
            path_help == path_help.append("k_14V/");
            break;
        case 29:
        case 30:
            path_help == path_help.append("k_15V/");
            break;
        default:
            help = false;
    }
...
int solve(CostsGraph &G) {
    ...
    cout << "  Reduction in " << used_time << " sec caused " << count << " edge changes. Graph reduced from "
         << old_size << " to " << (PI.getGraph()).getSize() << endl;
