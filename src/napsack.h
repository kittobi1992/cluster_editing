...
public:
    ...
    getNapsackSolution(vector<Tupel> &Tupel_list, long long &matrix_x_size, long long &matrix_y_size,
                       long double &delta_u, long double &delta_v, long double upper_bound, long long infinity) {
        // create linear array
        ...
        for (int i = 0; i < Tupel_list.size(); i++) {
            ...
            long long max_value = compute_second_D(array, inf_field, Tupel_list[i].x_up, Tupel_list[i].x_down,
                                                   Tupel_list[i].y_up, Tupel_list[i].y_down, matrix_x_size, infinity);
...
private:
    ...
    compute_second_D(Array<field_type> &array, field_type &inf_field, long long x_up, long long x_down, long long y_up,
                     long long y_down, long long x_size, long long infinity) {
